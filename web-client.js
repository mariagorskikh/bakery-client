...
app.get('/', (req, res) => {
  res.send(`
    ...
    <html>
      ...
      <body>
        <h1>🧁 Bakery Client - MCP with Claude</h1>
        <p>Ask any question! The client uses Claude to process requests and can fetch website content.</p>
...
// Start the server
app.listen(PORT, () => {
  console.log(`Bakery Client running on http://localhost:${PORT}`);
